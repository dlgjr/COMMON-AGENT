...
# COMMON-AGENT / ms-swift OPD stage 1
# DLC topology:
#   node rank 0:
...
SCRIPT_DIR="/mnt/nas/bihaoran/common_agent/scripts/opd/opd_v1"
...
OUTPUT_DIR="${OUTPUT_DIR:-/mnt/nas/bihaoran/common_agent/output/opd/opd_v1}"
...
export WANDB_NAME="${WANDB_NAME:-qwen3.5-4b-opd-v1}"
mkdir -p "$WANDB_DIR"
...
if [ "$NODE_RANK" = "0" ]; then
  ...
  echo "[DONE] OPD V1 final checkpoint: $current_model"
  ...
  echo "[DONE] OPD V1 trainer final checkpoint: $current_checkpoint"
